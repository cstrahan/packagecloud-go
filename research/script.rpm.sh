...
main ()
{
  repo_config_name=USER_REPOSITORY
  detect_os
  curl_check
  ...
  yum_repo_config_url="https://REDACTED_TOKEN:@packagecloud.io/install/repositories/USER/REPOSITORY/config_file.repo?os=${os}&dist=${dist}&name=${unique_id}&source=script"
  ...
  if [ "$curl_exit_code" = "22" ]; then
    ...
    echo
    echo "Contact contact the owner of this repository/package with information about your system for help."
    [ -e $yum_repo_path ] && rm $yum_repo_path
    exit 1
